...
class CreateOrderRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'design' => 'string',
        'expires_at' => '\Swagger\Client\Model\Instant',
        'locale' => 'string',
     ...
     * Sets attachment
     *
     * @param \Swagger\Client\Model\Attachment $attachment Extra Merchant Data (additional information) required for additional risk check. The required parameters will be described in the appendix of contract agreement.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Address $billing_address Provide the billing address of the customer, if you have collected already. If not, then Klarna will collect the details inside the iFrame before authorization.
     *
     * @return $this
     */
     ...
     * Sets customer
     *
     * @param \Swagger\Client\Model\Customer $customer Object to provide the details of the customer making the payment.
     *
     * @return $this
     */
     ...
     * Gets expires_at
     *
     * @return \Swagger\Client\Model\Instant
     */
     ...
     * Sets expires_at
     *
     * @param \Swagger\Client\Model\Instant $expires_at Session expiration date
     *
     * @return $this
     */
     ...
     * Sets merchant_urls
     *
     * @param \Swagger\Client\Model\MerchantUrls $merchant_urls Used to send in the different merchant URLs that Klarna needs at different stages of the process.
     *
     * @return $this
     */
     ...
     * Sets options
     *
     * @param \Swagger\Client\Model\Options $options Design customization options for the Klarna Payments iframe. The design options are limited to changing colors. It is not possible to change the font or other designs at the moment.
     *
     * @return $this
     */
     ...
     * Sets order_lines
     *
     * @param \Swagger\Client\Model\OrderLine[] $order_lines The array containing list of line items that are part of this order. Maximum of 1000 line items could be processed in a single order.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\PaymentMethodCategory[] $payment_method_categories Available payment method categories
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Address $shipping_address The shipping address of the consumer. Please note that this is not needed unless the customer has explicitly chosen to enter a separate shipping address. Otherwise the billing address will be automatically cloned.
     *
     * @return $this
     */
